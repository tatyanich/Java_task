...
public class Length implements IOperation {
    ...
    private String operationName = "2";
    ...
    public String analyzeTextFile(String filePath) throws FileNotFoundException {
        ...
        scanner.close();
        return findMaxWordsWithDuplicate(statistics).toString();

    }

    private  List<String> findMaxWordsWithDuplicate(Map<String, Integer> mapOfString) {
